        ...
        <div className="min-h-screen bg-slate-50">
            <div className="max-w-6xl mx-auto px-6 py-12">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-slate-400 mt-1">{items.length} টি আইটেম পাওয়া গেছে</p>
                </div>
                ...
                {items.length === 0 && (
                    <div className="text-center py-24 text-slate-400">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 mx-auto mb-4 text-slate-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
