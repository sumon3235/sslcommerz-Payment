    ...
    if (cart.length === 0) {
        return (
            <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center text-slate-400">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-20 h-20 mb-4 text-slate-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-sm text-slate-400 mt-1">{totalItems} টি item আছে</p>
                    </div>
                    <button
                        onClick={clearCart}
                ...
                <div className="flex flex-col gap-6">
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-slate-100 bg-slate-50">
                                    ...
                                    <th className="text-left px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Quantity</th>
                                    <th className="text-left px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Subtotal</th>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 ml-auto w-full max-w-sm">
                        <h3 className="text-base font-semibold text-slate-800 mb-4">Order Summary</h3>
                        ...
                        <button className="w-full py-3 rounded-xl text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 shadow-md shadow-indigo-200 transition-all">
                            Proceed to Checkout
                        </button>
